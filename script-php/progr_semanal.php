...
<title>SISCOM - Programacion Semanal</title>
              ...
              <ul class="posts">
                <li>
                    <div class="post_entry">
                        ...
                        <h2><a href="blog-single.html" data-transition="flip">Design is not just what it looks like and feels like.</a></h2>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="post_entry">
                        ...
                        <div class="post_title">
                        <h2><a href="blog-single.html" data-transition="flip">Fashion fades, only style remains the same.</a></h2>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="post_entry">
                        ...
                        <div class="post_title">
                        <h2><a href="blog-single.html" data-transition="flip">Sed ut perspiciatis unde omnis iste accusantium.</a></h2>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="post_entry">
                        ...
                        <div class="post_title">
                        <h2><a href="blog-single.html">Nemo enim ipsam voluptatem quia voluptas.</a></h2>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="post_entry">
                        ...
                        <div class="post_title">
                        <h2><a href="http://tiny.cc/lt774x">Totam rem aperiam, eaque ipsa quae inventore.</a></h2>
                        </div>
                    </div>
                </li>
                <li>
